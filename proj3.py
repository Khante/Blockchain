...
def server():
    ...
    while True:
        ...
        generated_block = {'block_number':(block_chain[-1]['block_number']+1), 'prev_hash':str(block_chain[-1]['current_hash']), 'current_hash':str(hashlib.md5(hash_string.encode()).hexdigest()),\
